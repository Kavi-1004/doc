...
export async function POST(request: NextRequest) {
  ...
  const { companyId, customerId, quotationId, purchaseOrderId, deliveryOrderId, dueDate, items, discount, taxRate, footer } = body;
  ...
  const invoiceNumber = await generateDocumentId(company.shortCode, "I");
